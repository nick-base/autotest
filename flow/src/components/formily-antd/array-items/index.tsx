...
type ComposedArrayItems = React.FC<React.PropsWithChildren<React.HTMLAttributes<HTMLDivElement> & IArrayBaseProps>> &
  ArrayBaseMixins & {
    Item?: React.FC<
...
const SortableItem: ReactFC<React.HTMLAttributes<HTMLDivElement> & SortableElementProps> = SortableElement(
...
const SortableList: ReactFC<React.HTMLAttributes<HTMLDivElement> & SortableContainerProps> = SortableContainer(
  (props: React.PropsWithChildren<React.HTMLAttributes<HTMLDivElement>>) => {
    const prefixCls = usePrefixCls('formily-array-items');
    return (
