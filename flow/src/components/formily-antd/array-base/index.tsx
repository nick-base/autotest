...
import { DeleteOutlined, DownOutlined, UpOutlined, PlusOutlined, MenuOutlined, CopyOutlined } from '@ant-design/icons';
...
export type ArrayBaseMixins = {
  ...
  MoveDown?: React.FC<React.PropsWithChildren<AntdIconProps & { index?: number }>>;
  SortHandle?: React.FC<React.PropsWithChildren<AntdIconProps & { index?: number }>>;
  Index?: React.FC;
